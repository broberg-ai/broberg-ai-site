/* Inline Lucide icon paths — the site has no client icon lib; these SSR as
   static SVG. Stroked, currentColor → tinted via .card-icon. Shared between
   FlagshipSlides (Cards block) and SolutionPage (feature grid). */
